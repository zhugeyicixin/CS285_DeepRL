...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            observations = ob_no[i*num_data_per_env: (i+1)*num_data_per_env] # TODO(Q1)
            actions = ac_na[i*num_data_per_env: (i+1)*num_data_per_env] # TODO(Q1)
            next_observations = next_ob_no[i*num_data_per_env: (i+1)*num_data_per_env] # TODO(Q1)
            ...
            # TODO: where to update the data_statistics?
